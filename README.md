...
If you are using the NeoFS mainnet, we recommend that you do not change `TEST_RESULTS_NEOFS_NETWORK_DOMAIN`
and `TEST_RESULTS_HTTP_GATE` environment variables.
