...
def parse_args():
    ...
    parser.add_argument('--neofs_domain', required=True, type=str,
    ...
    parser.add_argument('--files-dir', type=str, help='Path to the directory with the files to be pushed'),
...
def change_root_dir_to_container_id(root_directory: str, current_directory: str, run_id: str) -> str:
    """
...
def push_files_to_neofs(directory: str, neofs_domain: str, wallet: str, cid: str, run_id: str,
    ...
    for subdir, dirs, files in os.walk(directory):
        ...
        neofs_path_attr = change_root_dir_to_container_id(directory, current_dir_name, run_id)
        ...
        for filename in files:
            ...
            try:
                compl_proc = subprocess.run(base_cmd_with_file, check=True, text=True,
...
if __name__ == '__main__':
    ...
    push_files_to_neofs(args.files_dir, args.neofs_domain, args.wallet, args.cid, args.run_id, args.expire_at,
                        neofs_password)
